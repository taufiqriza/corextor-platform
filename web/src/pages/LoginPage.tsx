        ...
        <div className="cx-login-grid" style={{ minHeight: '100vh' }}>
            ...
            >
                ...
                <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 400 }}>
                    ...
                    <p style={{ fontSize: 14, color: '#93C5FD', lineHeight: 1.7 }}>
            ...
            >
                <div style={{ maxWidth: 380, width: '100%', margin: '0 auto' }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <label style={{ fontSize: 11, fontWeight: 700, color: T.textSub, display: 'block', marginBottom: 6 }}>
                            Email
                        </label>
                        <div style={{
                        ...
                        >
                            {isLoading ? <Loader2 size={16} style={{ animation: 'spin 1s linear infinite' }} /> : <>Masuk <ArrowRight size={15} /></>}
                        </button>
                    </form>
